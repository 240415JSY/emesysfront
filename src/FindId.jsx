...
export default function Component() {
    return (
        <>
            <div
                className="skin_block s"
                style={{
                    position: "relative",
                }}
            >
                <div
                    className="normal_module s"
                    style={{
